...
router.register('contratos-vendedor-email-quantidade/seu-email-aqui/quantidade', viewsets.ContratosVendedorEmailQuantidadeViewSet, basename='contratos-vendedor-email-quantidade')
urlpatterns = [
  ...
  path('contratos-vendedor-email-quantidade/<str:email>/<int:quantidade>/', viewsets.ContratosVendedorEmailQuantidadeViewSet.as_view({'get': 'list'}), name='contratos-vendedor-email-quantidade'),
