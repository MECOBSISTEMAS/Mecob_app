    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.perfil')),
            ],
            options={
                'db_table': 'pessoas',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arquivos_id_remessa', models.ForeignKey(blank=True, db_column='arquivos_id_remessa', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.arquivos')),
                ('arquivos_id_retorno_consolidado', models.ForeignKey(blank=True, db_column='arquivos_id_retorno_consolidado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='teds_arquivos_id_retorno_consolidado_set', to='Core_app.arquivos')),
                ('arquivos_id_retorno_previa', models.ForeignKey(blank=True, db_column='arquivos_id_retorno_previa', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='teds_arquivos_id_retorno_previa_set', to='Core_app.arquivos')),
                ('arquivos_id_retorno_processamento', models.ForeignKey(blank=True, db_column='arquivos_id_retorno_processamento', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='teds_arquivos_id_retorno_processamento_set', to='Core_app.arquivos')),
                ('pessoas_id_inclusao', models.ForeignKey(db_column='pessoas_id_inclusao', on_delete=django.db.models.deletion.DO_NOTHING, related_name='teds_pessoas_id_inclusao_set', to='Core_app.pessoas')),
                ('pessoas_id_vendedor', models.ForeignKey(db_column='pessoas_id_vendedor', on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas')),
            ],
            options={
                'db_table': 'teds',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_mail', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.sendmail')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='pessoas',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.status'),
        ),
        migrations.CreateModel(
            name='PerfilModulo',
            fields=[
                ...
                ('modulo', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.modulo')),
                ('perfil', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.perfil')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contratos', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.contratos')),
                ('pessoas', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teds', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.teds')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proprietario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas')),
            ],
            options={
                'db_table': 'haras',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(db_comment='(virtual, presencial, online)', max_length=200)),
                ('leiloeiro', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas')),
            ],
            options={
                'db_table': 'eventos',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arquivos', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.arquivos')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='comprador',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='contratos_comprador_set', to='Core_app.pessoas'),
        ),
        migrations.AddField(
            model_name='contratos',
            name='contratos_id_pai',
            field=models.ForeignKey(blank=True, db_column='contratos_id_pai', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.contratos'),
        ),
        migrations.AddField(
            model_name='contratos',
            name='eventos',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.eventos'),
        ),
        migrations.AddField(
            model_name='contratos',
            name='pessoas_id_inclusao',
            field=models.ForeignKey(db_column='pessoas_id_inclusao', on_delete=django.db.models.deletion.DO_NOTHING, related_name='contratos_pessoas_id_inclusao_set', to='Core_app.pessoas'),
        ),
        migrations.AddField(
            model_name='contratos',
            name='vendedor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arquivos_id_remessa', models.ForeignKey(blank=True, db_column='arquivos_id_remessa', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.arquivos')),
                ('arquivos_id_retorno', models.ForeignKey(blank=True, db_column='arquivos_id_retorno', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='contratoparcelas_arquivos_id_retorno_set', to='Core_app.arquivos')),
                ('boletos_avulso', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.boletosavulso')),
                ('contratos', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.contratos')),
                ('pessoas_id_atualizacao', models.ForeignKey(blank=True, db_column='pessoas_id_atualizacao', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas')),
                ('teds', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.teds')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contratos', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.contratos')),
                ('lote', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.lotes')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='contratos',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.contratos'),
        ),
        migrations.AddField(
            model_name='boletosavulso',
            name='pessoas',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas'),
        ),
        migrations.AddField(
            model_name='boletosavulso',
            name='pessoas_id_inclusao',
            field=models.ForeignKey(db_column='pessoas_id_inclusao', on_delete=django.db.models.deletion.DO_NOTHING, related_name='boletosavulso_pessoas_id_inclusao_set', to='Core_app.pessoas'),
        ),
        migrations.AddField(
            model_name='arquivos',
            name='boletos_avulso',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.boletosavulso'),
        ),
        migrations.AddField(
            model_name='arquivos',
            name='contratos',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='pessoas_id_envio', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas'),
        ),
        migrations.CreateModel(
            name='Alertas',
            fields=[
                ...
                ('pessoas_id_cadastro', models.ForeignKey(db_column='pessoas_id_cadastro', on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.pessoas')),
                ('pessoas_id_destino', models.ForeignKey(db_column='pessoas_id_destino', on_delete=django.db.models.deletion.DO_NOTHING, related_name='alertas_pessoas_id_destino_set', to='Core_app.pessoas')),
            ],
            options={
                'db_table': 'alertas',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocolos', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Core_app.protocolos')),
            ],
            options={
